...
class sdf_data {
	...
	private static $SPARK_TEAM = array('schavery@gmail.com');
...
function sdf_get_form() { ?>
	<div id="sdf_form">
		<form method="post">
			...
			<br>
			<label for"address1">Mailing Address: <span class="label-required">*</span></label>
			<div class="whole">
			...
			<label for="cc-zip">Billing ZIP / Postal Code: <span class="label-required">*</span></label>
			<div class="whole">
